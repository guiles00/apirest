...
workers.processCheckOutcome = function(originalCheckData,checkOutcome){
  ...
  //debug(originalCheckData,checkOutcome,state,alertWarranted,timeOfCheck)
  ...
  debug(checkOutcome,state,alertWarranted);
  // Save the updates
...
workers.rotateLogs = ()=>{
  // if false, returns not ziped files
  // if true, returns all logs
      ...
      logs.forEach((logName)=>{
        ...
        _logs.compress(logId,newFileId,(err)=>{
          ...
          if(!err){
            ...
            debug("Error trying to compress the file");
          }
        });
      })
    }else{
...
workers.init = function(){
  ...
  // Execute rotate logs every x time
